...
class ThreatActor:
    ...
    def list(self, **kwargs) -> dict:
        ...
        self.opencti.log(
            "info",
            "Listing Threat-Actors with filters " + json.dumps(filters) + ".")
        query = ("""
    ...
    def import_from_stix2(self, **kwargs):
        ...
        if stix_object is not None:
            return self.create(
                ...
                if "threat_actor_types" in stix_object else None,
                ...
                if "primary_motivation" in stix_object else None,
                secondary_motivations=stix_object["secondary_motivations"]
                if "secondary_motivations" in stix_object else None,
                personal_motivations=stix_object["personal_motivations"]
                if "personal_motivations" in stix_object else None,
